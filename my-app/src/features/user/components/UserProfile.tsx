...
const UserProfile = () => {
  ...
  const handleRemove = (e, index) => {
    let updateUser = { ...userInfo, addresses: [...userInfo.addresses] }
  ...
  const handleEdit = (addressUpdate, index) => {
    ...
    dispatch(updateUserAsync(newUser) as any);
  ...
  return (
    <div>
      <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6 inline-flex-space-between" >
         ...
         {userInfo.role === "admin" && <h3 className="text-xl my-5 font-bold tracking-tight ">
            role : {userInfo.role}
          </h3> }
        </div>
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          <button
            ...
            type="submit"
            className="rounded-md my-5 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-600"
          >
            Add New Address
          </button>
          {showAddAddressForm ? (
              ...
              <div className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
                ...
                <div className="hidden sm:flex sm:flex-col sm:items-end">
                  ...
                  <button
                    ...
                    type="button"
                    className="font-medium text-red-600 hover:text-teal-500"
                  >
                    Remove
                  </button>
                </div>
