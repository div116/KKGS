...
import { addProductAsync, clearSelectedproduct, fetchProductByIdAsync, selectAllBrands, selectAllCategories, selectedProduct, updateProductAsync } from '../../Product/productSlice';
        ...
        <>
            <form noValidate onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mt-6 flex items-center justify-end gap-x-6">
                    ...
                    { selectedProductByID && <button onClick={handleDelete}
