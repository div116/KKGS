...
export const fetchAllProductsByFilterAsync = createAsyncThunk('product/fetchAllProductsByFilter', async (filters: any) => {
  const response : any = await fetchAllProductsByFilter(filters)
  return response.data
})
